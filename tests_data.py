...
param = (
    ...
    ("get", "user", "user_template.json", {"user_id": 0}, {"content-type": "application/json"}, {"user_id": 2}, 200), #Должно выдавать 0 юзера
    ("get", "book", "book_template.json", {"book_id": 0}, {"content-type": "application/json"}, {"book_id": 2}, 200), #Должно выдавать 0 книгу
